...
public class Individuo implements Comparable<Individuo>{
    ...
    public Individuo(Integer precisao, Double minimo, Double maximo, Integer nVar, Integer maxPesos) {
    ...
    public void criar() {
        ...
        for(int i=0;i<this.getnVar();i++)
        {
            this.getPesos().add(Math.abs(1+rnd.nextInt(this.MaxPesos)));
        }
    ...
    if (this.funcaoObjetivo > t.getFuncaoObjetivo())
    {
        return -1;
    }
    if (this.funcaoObjetivo < t.getFuncaoObjetivo())

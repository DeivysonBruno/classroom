...
public class DEReal implements Metodo {
    ...
    public DEReal(Double minimo, Double maximo, ProblemaRastringin problema, Integer gmax, Integer D, Integer Np, Double F, Double Cr) {
        this.minimo = minimo;
        this.maximo = maximo;
    ...
    public ProblemaRastringin getProblema() {
        return problema;
    }
    ...
    public Individuo executar() {
       ...
       Collections.sort(populacao.getIndividuos());
        ...
        System.out.println(populacao.getIndividuos().get(0).getFuncaoObjetivo() + " ; " + populacao.getIndividuos().get(99).getFuncaoObjetivo()+";"+seconds);
